...
let person = {id: 1, name:"jerry", email: "jerry@jerry.com"};
...
function makeSmartPerson(name) {
  ...
  console.log(makeSmartPerson("jimbab"));
  console.log(makeSmartPerson().sum(1,2));
  console.log(makeSmartPerson("jimbab").speak());
